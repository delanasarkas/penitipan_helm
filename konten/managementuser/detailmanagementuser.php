...
<head>
  ...
  <title>PT HERO SUPERMARKET TBK - DETAIL MANAGEMENT USER</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Detail Management User -->
          <div class="d-sm-flex justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 ">DETAIL MANAGEMENT USER </h1>
          </div>
          ...
          <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <h4>Divisi Bagian</h4>
                <p>IT</p>
                <a href="managementuser.php" class="btn btn-danger btn-block mt-5">KEMBALI</a>
              </div>
            </div>
            </div>
