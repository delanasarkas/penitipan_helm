...
<head>
  ...
  <title>PT HERO SUPERMARKET TBK - EDIT MANAGEMENT USER</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Edit Management User -->
          <div class="d-sm-flex justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 ">EDIT MANAGEMENT DATA </h1>
          </div>
              ...
              <div class="card">
                <div class="card-body">
                  <form>
                    ...
                    <a href="managementuser.php" class="btn btn-primary btn-block">EDIT</a>
                    <a href="managementuser.php" class="btn btn-danger btn-block">KEMBALI</a>
