...
<head>
  ...
  <title>PT HERO SUPERMARKET TBK - EDIT LOKER</title>
              ...
              <div class="card">
                <div class="card-body">
                  <form>
                    ...
                    <div class="form-group">
                      <label for="exampleFormControlInput1">STATUS LOKER</label>
                      <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Status Loker...">
                    </div>
                    </div>
                    </div>
                    <a href="loker.php" class="btn btn-primary btn-block">EDIT</a>
                    <a href="loker.php" class="btn btn-danger btn-block">KEMBALI</a>
