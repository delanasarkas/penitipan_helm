...
<head>
  ...
  <title>PT HERO SUPERMARKET TBK - DATA LOKER</title>
...
<body class="bg-info">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - DATA LOKER -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="loker.php">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <!-- Page Data Loker,search,cetak report, Tambah Data -->
          <div class="d-sm-flex justify-content-between mb-4">
            ...
            <a href="#" class="d-none d-sm-inline-block btn btn-sms btn-primary shadow-sm"
              style="margin-right:-632px"><i class="fas fa-download fa-sm text-white-50"></i> Cetak Report</a>
            <a href="tambahloker.php" class="d-none d-sm-inline-block btn btn-sms btn-primary"><i
              ...
              <table id="example" class="table nowrap table-bordered table-striped table-hover display"
                ...
                <thead class="bg-primary text-white text-center ">
                  <tr>
                    ...
                    <th style="border:1px solid black">No Loker </th>
                    <th style="border:1px solid black">Status Loker</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td style="border:1px solid black">Loker Belum Diisi</td>
                    <td style="border:1px solid black">

                      <a href="editloker.php" class="btn btn-sms btn-primary btn-sm"></i> Edit</a>
