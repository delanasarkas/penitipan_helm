...
<head>
  ...
  <title>PT HERO SUPERMARKET TBK - Dashboard</title>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <input type="text-center" class="form-control bg-light border-0 small btn " placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div class="font-weight-bold">
                    <div class="text-truncate">Telah Menyimpan</div>
                    <div class="small text-gray-500">Agus · 58m</div>
                  </div>
                </a>
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                  ...
                  <div>
                    <div class="text-truncate">Telah Menyimpan</div>
                    <div class="small text-gray-500">Farhan · 30m</div>
                  </div>
                </a>
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                  ...
                  <div>
                    <div class="text-truncate">Telah Menyimpan</div>
                    <div class="small text-gray-500">Endri S· 2d</div>
                  </div>
                </a>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <!-- Jumlah Penitipan Barang Card Example -->
            <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Jumlah Penitipan Barang</div>
              ...
              <!-- Jumlah Loker Tersedia Card Example -->
              <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">Jumlah Loker Tersedia</div>
          ...
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                <!-- Card Header - REPORT STATIC -->
                    <h6 class="m-0 font-weight-bold text-primary text-center">REPORT STATIC</h6>
                  </div>
                </div>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <p>3. Kita Bersama-sama menciptakan kesatuan manajemen yang sempurna, sehingga Hero dapat berpartisipasi dalam Pembangunan negara kita. Mencapai kesejahteraan sesama karyawan dan menuju kemajuan perusahaan</p>
                  </h6>
                </div>
              </div>  
            </div>
