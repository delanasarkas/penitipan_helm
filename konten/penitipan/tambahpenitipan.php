...
<head>
  ...
  <title>PT HERO SUPERMARKET TBK - TAMBAH PENITIPAN</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Tambah Data Penitipan -->
          <div class="d-sm-flex justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 ">TAMBAH DATA PENITIPAN </h1>
          </div>

          <!-- Page Tambah Penitipan -->
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <form>
                    ...
                    <a href="penitipan.php" class="btn btn-success btn-block">SIMPAN</a>
